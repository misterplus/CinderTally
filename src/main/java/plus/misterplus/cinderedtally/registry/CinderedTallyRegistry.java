...
public class CinderedTallyRegistry {
    ...
    public static final IRecipeType<CrucibleRecipe> RECIPE_CRUCIBLE = IRecipeType.register("cinderedtally:crucible");
    ...
    public static final Item PARCHMENT = register(ITEMS, "parchment", new Item(new Item.Properties().tab(TAB_CINDEREDTALLY)));
    ...
    private static final DeferredRegister<IRecipeSerializer<?>> RECIPE_SERIALIZERS = DeferredRegister.create(ForgeRegistries.RECIPE_SERIALIZERS, CinderedTally.MOD_ID);
    public static final SpecialRecipeSerializer<RecipeRepairCinderedTally> REPAIR_CINDERED_TALLY = register(RECIPE_SERIALIZERS, "repair_cindered_tally", new SpecialRecipeSerializer<>(RecipeRepairCinderedTally::new));
    public static final IRecipeSerializer<CrucibleRecipe> RECIPE_SERIALIZER_CRUCIBLE = register(RECIPE_SERIALIZERS, "crucible", new CrucibleRecipe.Serializer());
