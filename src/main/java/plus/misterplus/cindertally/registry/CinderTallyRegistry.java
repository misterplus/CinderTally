...
public class CinderTallyRegistry {
    ...
    public static final ContainerType<CinderTallyContainer> CONTAINER_CINDER_TALLY = register(CONTAINERS, "cinder_tally", IForgeContainerType.create((windowId, playerInv, extraData) -> {
        return new CinderTallyContainer(windowId, playerInv, LifespanHelper.getCinderTallyInventory(extraData.readInt()));
    }));
